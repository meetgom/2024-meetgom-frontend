...
export const SelectBox: React.FC<SelectBoxProps> = ({
  ...
  return (
    <div className="relative w-80">
      ...
      <div
        className={`bg-white text-black border border-[#EFEFEF] placeholder:text-black rounded-md leading-none w-80 h-12 p-3 flex items-center justify-between cursor-pointer focus-within:outline focus-within:outline-black`}
